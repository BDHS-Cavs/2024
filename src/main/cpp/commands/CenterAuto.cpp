...
CenterAuto::CenterAuto(Drivetrain* m_swerve, Climber* m_climber, Shooter* m_shooter, Intake* m_intake, Vision* m_vision, Conveyer* m_conveyer)
:m_swerve(m_swerve),
m_climber(m_climber),
m_shooter(m_shooter),
m_intake(m_intake),
...
void CenterAuto::Execute() {
    ...
    {
        //TODO m_drive->AutoMotivateBackward(); //drive for 0.85s
        m_intake->IntakeRun();
    }
    else if(m_timer.Get() >= period5 && m_timer.Get() < period6) //starts at 6 ends at 6.85 (0.85s)
    {
        //TODO m_drive->AutoMotivateForward(); //drive for 0.85s
    }
    ...
    {
            //TODO m_drive->AutoMotivateBackward();
    }
