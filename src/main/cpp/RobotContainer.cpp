...
m_controllerButton8.WhileTrue(ConveyerForwardCommand(&m_conveyer).ToPtr());   
}
...
frc2::Command* RobotContainer::GetAutonomousCommand() {
 ...
 double RobotContainer::getX() {
         return abs(m_drivecontroller.GetLeftX()) > DriveConstants::DEADZONE_XY ? m_drivecontroller.GetLeftX() : 0;
     }
 double RobotContainer::getY() {
         return abs(m_drivecontroller.GetLeftY()) > DriveConstants::DEADZONE_XY ? m_drivecontroller.GetLeftY() : 0;
     }
 double RobotContainer::getZ() {
         double z = m_drivecontroller.GetRightX();
