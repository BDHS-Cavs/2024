...
Talon::Talon(int deviceID, double gearRatio, ControlMode controlMode, Encoder encoder, boolean flippedSensor, double protectedZoneStart, double protectedZoneSize){

ControlMode current = ControlMode.Current;
ControlMode follower = ControlMode.Follower;
ControlMode percent = ControlMode.PercentOutput;
ControlMode position = ControlMode.Position;
ControlMode velocity = ControlMode.Velocity;
ControlMode disabled = ControlMode.Disabled;
